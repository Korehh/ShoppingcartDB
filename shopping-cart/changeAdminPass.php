            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Change Password Password</h1>
                    ...
                    <div class="container-fluid">
                        <form class="user" method="post">
                            ...
                            <div class="form-group">
                                <button type="submit" name="loginbtn" class="btn btn-primary btn-user btn-block text-white">Change Password</button>
                            </div>
                        </form>                    
                        <br>
